...
const { getAllEventos,setEvento, deleteEvento, updateEvento, getEventoById, sendEventosSemanalesHandler, remindEventosHandler, sendEventosDiariosHandler } = require('./evento.controller.js');
